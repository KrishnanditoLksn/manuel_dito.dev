        ...
        <section id="projects" className="bg-white">
            ...
            <div className="grid grid-cols-3 gap-3 px-4 mx-auto max-w-screen-xl mb-80">
                {projectList().map((project) => (
                    <div key={project.keyList} className="max-w-sm rounded overflow-hidden shadow-lg">
                        ...
                        <span
                            className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">{project.category}</span>
                        </div>
                    </div>
                ))}
            </div>
